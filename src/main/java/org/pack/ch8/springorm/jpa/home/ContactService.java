...
public class ContactService {
	...
	public static void main(String[] args) {
		...
		ctx.load("classpath:META-INF/spring/app-context-annotation-jpa-orm-home.xml");
		ctx.refresh();
		ContactService contactService = ctx.getBean("jpaContactService", ContactService.class);
//		findContacts(contactService);
		findContactsNative(contactService);
	...
	private static void findContactsNative(ContactService contactService) {
		System.out.println("Find only contacts");
