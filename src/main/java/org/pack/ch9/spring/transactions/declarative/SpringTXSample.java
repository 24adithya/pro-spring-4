...
public class SpringTXSample {
	public static void main(String[] args) {
		...
		ctx.load("classpath:META-INF/spring/app-context-annotation-data-transactions-jpa-declarative-home.xml");
		ctx.refresh();
		
		ContactService contactService = ctx.getBean("springTxDeclarativeContactService", ContactService.class);
